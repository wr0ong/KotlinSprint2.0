    ...
    data class MainScreenState(var data: String = "", val isLoading: Boolean = false) {
        fun loadData() {
            ...
            if ((startOrNot == "Да") || (startOrNot == "да") || (startOrNot == "yes") || (startOrNot == "Yes")) {
                ...
                Thread.sleep(1500)
                this.data += "android:text=\"Обновить\"\n" +
                ...
                Thread.sleep(1500)
                this.data += "<TextView android:id=\"@+id/wifiip\"\n" +
                        "            android:layout_width=\"wrap_content\"\n" +
                        "            android:layout_height=\"wrap_content\"\n" +
                        "            android:gravity=\"center_horizontal\"\n" +
...
fun main() {
    ...
    val viewModel: ViewModel = ViewModel(mainScreenState)
